...
class AnuntForm(forms.ModelForm):
    class Meta:
        ...
        'numar_camere': NumberInput(attrs={'class':'form-control', 'placeholder': 'Introdu suprafata utila'}),
        'numar_bai': NumberInput(attrs={'class':'form-control', 'placeholder': 'Introdu suprafata utila'}),
